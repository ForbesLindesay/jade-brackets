CodeMirror.defineMode('jade', function (config) {
  ...
  function tag(stream, state) {
    ...
    if (captures = stream.match(/^(\w(?:[-:\w]*\w)?)\/?/)) {
      ...
      if (state.lastTag === 'script') {
        state.assetType = 'application/javascript';
      }
      return 'tag';
    }
  }
    ...
    if (state.isAttrs) {
      ...
      if (state.inAttributeName && stream.match(/^[^=,\)!]+/)) {
        if (stream.peek() === '=' || stream.peek() === '!') {
          ...
          if ((state.lastTag === 'script' || state.lastTag === 'style') && stream.current().trim().toLowerCase() === 'type') {
      ...
      if (state.attributeIsType && tok === 'string') {
        state.assetType = stream.current().toString();
      }
  ...
  function dot(stream, state) {
    if (stream.eat('.')) {
      var strippedType = state.assetType.toLowerCase().replace(/"|'/g, '');
      var innerMode = null;
      if (state.lastTag === 'script') {
        switch (strippedType) {
          case '':
          ...
          case 'application/javascript':
            innerMode = 'application/javascript';
            break;

          case 'json':
          case 'application/json':
            innerMode = 'application/json';
            break;

          case 'ld+json':
          case 'jsonld':
          case 'application/ld+json':
            innerMode = 'application/ld+json';
            break;
          ...
          case 'text/x-coffeescript':
            innerMode = 'text/x-coffeescript';
            break;

          case 'livescript':
          case 'text/ls':
          case 'text/x-livescript':
          case 'application/x-livescript':
            innerMode = 'text/x-livescript';
            break;

          case 'typescript':
          case 'text/typescript':
            innerMode = 'text/typescript';
            break;
        }
        ...
        switch (strippedType) {
          ...
          case 'scss':
          case 'text/x-scss':
            innerMode = 'text/x-scss';
            break;

          case 'sass':
          case 'text/x-sass':
            innerMode = 'text/x-sass';
            break;

          case 'stylus':
          case 'text/stylus':
          case 'text/x-styl':
            innerMode = 'text/x-styl';
            break;

          case 'less':
          case 'text/less':
          case 'text/x-less':
            innerMode = 'text/x-less';
            break;
        }
      }
      setInnerMode(stream, state, innerMode);
